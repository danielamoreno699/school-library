...
**School Library** "In this project I will implement an OOP app that interacts with user when inserting data. For that prupose I will add a basic UI layer that will guide the user into the multiple options 
